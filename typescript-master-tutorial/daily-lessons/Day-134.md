# Day 134 - Thursday, 12 December 2024

Module: Core Type Modeling
Topic: Type alias vs interface

## Explanation
Today focus: Type alias vs interface. Learn the concept, write typed code, validate compiler feedback, and refine with best practices.
