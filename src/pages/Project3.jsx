...
import {
    ShoppingCart, Check, Copy, Play, AlertCircle, Code, BookOpen,
    Target, ArrowRight, ArrowLeft, Terminal, Lightbulb, HelpCircle,
    Info, Sparkles, Award, Package, Tag, DollarSign, CreditCard,
    Truck, Shield, Star, Heart, TrendingUp, Filter, Search,
    Plus, Minus, Trash2, RefreshCw, Settings, Download, Upload,
    Clock, Calendar, User, Lock, Unlock, Eye, EyeOff, Zap,
    BatteryCharging, Wifi, Smartphone, Monitor, Database, Server,
    ShoppingBag, Receipt, CheckCircle, XCircle, Percent, Gift
} from 'lucide-react';
                            ...
                            <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
                                {categories.map((category) => (
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-4 py-2 rounded-full whitespace-nowrap transition-colors ${selectedCategory === category.id
                                    ...
                                    <div key={product.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-lg font-medium ${product.inStock
